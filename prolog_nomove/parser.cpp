...
{
#line 174 "grammar.m"
 return canreduce( syntdefs, (topsymbol(2).get<opdef>()), lookahead. value( )); }
...
{
   { { 33, prolog::sym_Postfix }, 16 }, { { 29, prolog::sym_RPAR }, 34 }, { { 28, prolog::sym_DOUBLE }, 12 }, { { 28, prolog::sym_GLUEDQUOTEDIDENTIFIER }, 6 }, { { 21, prolog::sym_LSQBRACKET }, 5 },
   { { 9, prolog::sym_LPAR }, 23 }, { { 30, prolog::sym_RPAR }, 35 }, { { 21, prolog::sym_MaybeTerms }, 29 }, { { 5, prolog::sym_VARIABLE }, 8 }, { { 5, prolog::sym_IDENTIFIER }, 10 },
   { { 5, prolog::sym_Prefix }, 4 }, { { 5, prolog::sym_SomeTerms }, 20 }, { { 33, prolog::sym_Infix }, 15 }, { { 4, prolog::sym_Prefix }, 4 }, { { 15, prolog::sym_Prefix }, 4 },
   { { 4, prolog::sym_GLUEDQUOTEDIDENTIFIER }, 6 }, { { 0, prolog::sym_GLUEDQUOTEDIDENTIFIER }, 6 }, { { 4, prolog::sym_LPAR }, 2 }, { { 0, prolog::sym_OneTerm }, 7 }, { { 21, prolog::sym_LPAR }, 2 },
   { { 2, prolog::sym_INTEGER }, 11 }, { { 4, prolog::sym_GLUEDIDENTIFIER }, 9 }, { { 23, prolog::sym_LSQBRACKET }, 5 }, { { 21, prolog::sym_Term }, 19 }, { { 0, prolog::sym_QUOTEDIDENTIFIER }, 1 },
   { { 13, prolog::sym_RPAR }, 24 }, { { 15, prolog::sym_GLUEDQUOTEDIDENTIFIER }, 6 }, { { 28, prolog::sym_Prefix }, 4 }, { { 0, prolog::sym_IDENTIFIER }, 10 }, { { 15, prolog::sym_VARIABLE }, 8 },
   { { 5, prolog::sym_Term }, 19 }, { { 0, prolog::sym_Term }, 3 }, { { 5, prolog::sym_DOUBLE }, 12 }, { { 4, prolog::sym_VARIABLE }, 8 }, { { 26, prolog::sym_VARIABLE }, 8 },
   { { 0, prolog::sym_Prefix }, 4 }, { { 13, prolog::sym_Postfix }, 16 }, { { 23, prolog::sym_GLUEDQUOTEDIDENTIFIER }, 6 }, { { 5, prolog::sym_GLUEDQUOTEDIDENTIFIER }, 6 }, { { 15, prolog::sym_LSQBRACKET }, 5 },
   { { 23, prolog::sym_IDENTIFIER }, 10 }, { { 0, prolog::sym_INTEGER }, 11 }, { { 18, prolog::sym_BAR }, 26 }, { { 4, prolog::sym_DOUBLE }, 12 }, { { 2, prolog::sym_LPAR }, 2 },
   { { 17, prolog::sym_IDENTIFIER }, 14 }, { { 19, prolog::sym_IDENTIFIER }, 14 }, { { 20, prolog::sym_COMMA }, 28 }, { { 31, prolog::sym_Infix }, 15 }, { { 23, prolog::sym_Prefix }, 4 },
   { { 0, prolog::sym_GLUEDIDENTIFIER }, 9 }, { { 26, prolog::sym_DOUBLE }, 12 }, { { 2, prolog::sym_DOUBLE }, 12 }, { { 3, prolog::sym_IDENTIFIER }, 14 }, { { 33, prolog::sym_IDENTIFIER }, 14 },
   { { 4, prolog::sym_LSQBRACKET }, 5 }, { { 23, prolog::sym_DOUBLE }, 12 }, { { 5, prolog::sym_MaybeTerms }, 18 }, { { 0, prolog::sym_DOUBLE }, 12 }, { { 5, prolog::sym_LPAR }, 2 },
   { { 3, prolog::sym_Postfix }, 16 }, { { 4, prolog::sym_INTEGER }, 11 }, { { 15, prolog::sym_LPAR }, 2 }, { { 2, prolog::sym_GLUEDIDENTIFIER }, 9 }, { { 2, prolog::sym_IDENTIFIER }, 10 },
   { { 15, prolog::sym_GLUEDIDENTIFIER }, 9 }, { { 13, prolog::sym_Infix }, 15 }, { { 21, prolog::sym_GLUEDQUOTEDIDENTIFIER }, 6 }, { { 5, prolog::sym_INTEGER }, 11 }, { { 28, prolog::sym_LSQBRACKET }, 5 },
   { { 23, prolog::sym_Term }, 19 }, { { 2, prolog::sym_QUOTEDIDENTIFIER }, 1 }, { { 2, prolog::sym_Term }, 13 }, { { 5, prolog::sym_GLUEDIDENTIFIER }, 9 }, { { 6, prolog::sym_LPAR }, 21 },
   { { 7, prolog::sym_TERMINATOR }, 22 }, { { 2, prolog::sym_GLUEDQUOTEDIDENTIFIER }, 6 }, { { 2, prolog::sym_Prefix }, 4 }, { { 3, prolog::sym_Infix }, 15 }, { { 25, prolog::sym_Infix }, 15 },
   { { 26, prolog::sym_LSQBRACKET }, 5 }, { { 4, prolog::sym_IDENTIFIER }, 10 }, { { 31, prolog::sym_Postfix }, 16 }, { { 0, prolog::sym_LSQBRACKET }, 5 }, { { 15, prolog::sym_Term }, 25 },
   { { 26, prolog::sym_INTEGER }, 11 }, { { 15, prolog::sym_QUOTEDIDENTIFIER }, 1 }, { { 21, prolog::sym_IDENTIFIER }, 10 }, { { 15, prolog::sym_INTEGER }, 11 }, { { 15, prolog::sym_DOUBLE }, 12 },
   { { 28, prolog::sym_QUOTEDIDENTIFIER }, 1 }, { { 17, prolog::sym_Postfix }, 16 }, { { 26, prolog::sym_IDENTIFIER }, 10 }, { { 31, prolog::sym_IDENTIFIER }, 14 }, { { 4, prolog::sym_QUOTEDIDENTIFIER }, 1 },
   { { 17, prolog::sym_Infix }, 15 }, { { 18, prolog::sym_ListEnd }, 27 }, { { 19, prolog::sym_Postfix }, 16 }, { { 21, prolog::sym_QUOTEDIDENTIFIER }, 1 }, { { 2, prolog::sym_LSQBRACKET }, 5 },
   { { 25, prolog::sym_Postfix }, 16 }, { { 21, prolog::sym_GLUEDIDENTIFIER }, 9 }, { { 0, prolog::sym_Start }, 36 }, { { 21, prolog::sym_SomeTerms }, 20 }, { { 21, prolog::sym_Prefix }, 4 },
   { { 21, prolog::sym_VARIABLE }, 8 }, { { 21, prolog::sym_DOUBLE }, 12 }, { { 15, prolog::sym_IDENTIFIER }, 10 }, { { 2, prolog::sym_VARIABLE }, 8 }, { { 21, prolog::sym_INTEGER }, 11 },
   { { 4, prolog::sym_Term }, 17 }, { { 23, prolog::sym_QUOTEDIDENTIFIER }, 1 }, { { 28, prolog::sym_IDENTIFIER }, 10 }, { { 28, prolog::sym_INTEGER }, 11 }, { { 23, prolog::sym_GLUEDIDENTIFIER }, 9 },
   { { 23, prolog::sym_SomeTerms }, 20 }, { { 13, prolog::sym_IDENTIFIER }, 14 }, { { 0, prolog::sym_VARIABLE }, 8 }, { { 23, prolog::sym_INTEGER }, 11 }, { { 23, prolog::sym_LPAR }, 2 },
   { { 19, prolog::sym_Infix }, 15 }, { { 25, prolog::sym_IDENTIFIER }, 14 }, { { 26, prolog::sym_QUOTEDIDENTIFIER }, 1 }, { { 23, prolog::sym_MaybeTerms }, 30 }, { { 28, prolog::sym_LPAR }, 2 },
   { { 26, prolog::sym_GLUEDIDENTIFIER }, 9 }, { { 5, prolog::sym_QUOTEDIDENTIFIER }, 1 }, { { 26, prolog::sym_Term }, 31 }, { { 5, prolog::sym_LSQBRACKET }, 5 }, { { 26, prolog::sym_Prefix }, 4 },
   { { 26, prolog::sym_LPAR }, 2 }, { { 26, prolog::sym_GLUEDQUOTEDIDENTIFIER }, 6 }, { { 0, prolog::sym_LPAR }, 2 }, { { 27, prolog::sym_RSQBRACKET }, 32 }, { { 28, prolog::sym_VARIABLE }, 8 },
   { { 28, prolog::sym_GLUEDIDENTIFIER }, 9 }, { { 23, prolog::sym_VARIABLE }, 8 }, { { 28, prolog::sym_Term }, 33 }
};

const prolog::parser::statesymbol::map< std::vector< size_t >> prolog::parser::reductions =
{
   { { 25, prolog::sym_RSQBRACKET }, { 10 } }, { { 25, prolog::sym_RPAR }, { 10 } }, { { 25, prolog::sym_COMMA }, { 10 } }, { { 25, prolog::sym_Infix }, { 10 } },
   { { 25, prolog::sym_ListEnd }, { 10 } }, { { 17, prolog::sym_BAR }, { 9 } }, { { 17, prolog::sym_RPAR }, { 9 } }, { { 17, prolog::sym_Postfix }, { 9 } },
   { { 25, prolog::sym_IDENTIFIER }, { 10 } }, { { 17, prolog::sym_Infix }, { 9 } }, { { 14, prolog::sym_INTEGER }, { 21 } }, { { 14, prolog::sym_DOUBLE }, { 21 } },
   { { 14, prolog::sym_RSQBRACKET }, { 22 } }, { { 17, prolog::sym_IDENTIFIER }, { 9 } }, { { 14, prolog::sym_ListEnd }, { 22 } }, { { 17, prolog::sym_TERMINATOR }, { 9 } },
   { { 14, prolog::sym_VARIABLE }, { 21 } }, { { 14, prolog::sym_TERMINATOR }, { 22 } }, { { 14, prolog::sym_Infix }, { 22 } }, { { 14, prolog::sym_GLUEDIDENTIFIER }, { 21 } },
   { { 10, prolog::sym_GLUEDIDENTIFIER }, { 20 } }, { { 10, prolog::sym_IDENTIFIER }, { 20, 5 } }, { { 17, prolog::sym_ListEnd }, { 9 } }, { { 10, prolog::sym_LSQBRACKET }, { 20 } },
   { { 10, prolog::sym_VARIABLE }, { 20 } }, { { 10, prolog::sym_Infix }, { 5 } }, { { 10, prolog::sym_TERMINATOR }, { 5 } }, { { 10, prolog::sym_Term }, { 20 } },
   { { 25, prolog::sym_TERMINATOR }, { 10 } }, { { 14, prolog::sym_LSQBRACKET }, { 21 } }, { { 14, prolog::sym_Postfix }, { 22 } }, { { 10, prolog::sym_Prefix }, { 20 } },
   { { 10, prolog::sym_RPAR }, { 5 } }, { { 10, prolog::sym_COMMA }, { 5 } }, { { 14, prolog::sym_QUOTEDIDENTIFIER }, { 21 } }, { { 10, prolog::sym_BAR }, { 5 } },
   { { 10, prolog::sym_GLUEDQUOTEDIDENTIFIER }, { 20 } }, { { 14, prolog::sym_RPAR }, { 22 } }, { { 10, prolog::sym_ListEnd }, { 5 } }, { { 25, prolog::sym_Postfix }, { 10 } },
   { { 10, prolog::sym_DOUBLE }, { 20 } }, { { 10, prolog::sym_INTEGER }, { 20 } }, { { 17, prolog::sym_COMMA }, { 9 } }, { { 14, prolog::sym_LPAR }, { 21 } },
   { { 10, prolog::sym_Postfix }, { 5 } }, { { 14, prolog::sym_Term }, { 21 } }, { { 10, prolog::sym_LPAR }, { 20 } }, { { 14, prolog::sym_GLUEDQUOTEDIDENTIFIER }, { 21 } },
   { { 10, prolog::sym_QUOTEDIDENTIFIER }, { 20 } }, { { 14, prolog::sym_BAR }, { 22 } }, { { 25, prolog::sym_BAR }, { 10 } }, { { 14, prolog::sym_IDENTIFIER }, { 21, 22 } },
   { { 17, prolog::sym_RSQBRACKET }, { 9 } }, { { 14, prolog::sym_COMMA }, { 22 } }, { { 10, prolog::sym_RSQBRACKET }, { 5 } }, { { 14, prolog::sym_Prefix }, { 21 } }
};
