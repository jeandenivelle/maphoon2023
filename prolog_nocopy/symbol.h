...
namespace prolog { 
   ...
   enum symboltype
   {
      sym_TERMINATOR, sym_BAR, sym_SomeTerms, sym_INTEGER, 
      sym_VARIABLE, sym_DOUBLE, sym_RSQBRACKET, sym_Postfix, 
      sym_LSQBRACKET, sym_ListEnd, sym_Start, sym_COMMENT, 
      sym_IDENTIFIER, sym_Term, sym__recover_, sym_MaybeTerms, 
