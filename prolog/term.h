...
#include "../../tvm/optional.h" 
#include "../../tvm/unit.h" 
#include "../../tvm/field.h"
#include "../../tvm/local.h"
#include "../../tvm/very_equal.h" 
...
namespace prolog { 
   ...
   public:
      ...
      const term& operator = ( term&& ) noexcept;
      ~term( ) noexcept;
      ...
      struct mut_func
      {
         ...
         const term& sub( size_t iiii ) const
            { return xxxx -> repr. fld03. heap -> begin( ) [ iiii ]; }
         term extr_sub( size_t iiii )
         {
            if( iswritable( xxxx -> repr. fld03. heap ))
               return std::move( xxxx -> repr. fld03. heap -> begin( ) [ iiii ] );
            else
               return xxxx -> repr. fld03. heap -> begin( ) [ iiii ];
         }
